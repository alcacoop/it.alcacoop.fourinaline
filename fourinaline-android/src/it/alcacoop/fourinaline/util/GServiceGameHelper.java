...
package it.alcacoop.fourinaline.util;
...
public class GServiceGameHelper implements GooglePlayServicesClient.ConnectionCallbacks, GooglePlayServicesClient.OnConnectionFailedListener, OnSignOutCompleteListener {
   ...
   * @param clientsToUse
   *          The clients to use. Use a combination of
